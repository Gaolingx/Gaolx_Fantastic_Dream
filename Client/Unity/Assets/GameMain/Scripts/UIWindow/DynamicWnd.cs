    ...
    public class DynamicWnd : WindowRoot
    {
        ...
        public async void AddHpItemInfo(string mName, Transform trans, int hp)
        {
            ...
            else
            {
                ...
                GameObject go = await resSvc.LoadGameObjectAsync(Constants.ResourcePackgeName, PathDefine.HPItemPrefab, new Vector3(-1000, 0, 0), Vector3.zero, Vector3.one, true); //默认设置在屏幕外
