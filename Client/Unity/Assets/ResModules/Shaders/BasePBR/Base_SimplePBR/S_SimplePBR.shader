    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                surfaceData.normalTS = normalTS * normalFactor;
                half4 baseMap = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, input.uv) * _BaseColor;
                half4 smoothnessMap = SAMPLE_TEXTURE2D(_SmoothnessMap, sampler_SmoothnessMap, input.uv);
                ...
                inputData.shadowMask = GetShadowMask(input);
                #if defined(REQUIRES_VERTEX_SHADOW_COORD_INTERPOLATOR)
