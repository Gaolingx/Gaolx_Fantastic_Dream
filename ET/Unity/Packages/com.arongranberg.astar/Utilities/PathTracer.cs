...
namespace Pathfinding {
	...
	public struct PathTracer {
		...
		public LinkInfo GetLinkInfo (int partIndex = 0) {
			...
			return new LinkInfo {
					   relativeStart = part.startPoint,
					   relativeEnd = part.endPoint,
		...
		/// </summary>
		static void RemoveGridPathDiagonals (PathPart[] parts, int partIndex, ref CircularBuffer<GraphNode> path, NNConstraint nnConstraint, ITraversalProvider traversalProvider, Path pathObject) {
			int inserted = 0;
